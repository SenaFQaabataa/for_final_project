...
Route::middleware(['auth', 'user-access:cbe'])->group(function () {
    Route::prefix('cbe')->group(function () {
        ...
        Route::prefix('/department')->group(function (){
            Route::get('/add', [CbeController::class, 'create'])->name('cbe.department.add');
            Route::post('/add', [CbeController::class, 'store'])->name('cbe.department.store');
            ...
            Route::get('/edit/{department}', [CbeController::class, 'edit'])->name('cbe.department.edit');
